    ...
    <div class="col s8 m8">
      <div class="card white">
        <div class="card-content ">
          <span class="card-title">Riwayat Obat atas nama <?php echo $balita->nama; ?></span>
           <div class="responsive-table">
                            <table class="table table-striped table-bordered" id="table-datatable" style="width:100%;">
                                ...
                                <tbody>
                                    <?php 
                        $where = array('no_rekamedis' => $this->session->userdata('id') ,'kategori'=>'Balita','id_balita'=> $id_balita);
