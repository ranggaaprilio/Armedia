            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo base_url() . 'pendaftaran/clear_daftar'; ?>" class="btn btn-rounded btn-xs btn-danger text-white ">Kosongkan Pendaftaran</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    foreach ($daftar as $u) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url() . 'pendaftaran/delete_daftar/' . $u->no_rawat ?>" class="btn btn-warning btn-xs"><i class="fa fa-trash"></i></a>
                                                <?php if ($u->status=='1') {?>
                                                    <a href="<?php echo base_url() . 'pendaftaran/selesai/' . $u->no_rawat ?>" class="btn btn-success btn-xs"><i class=" fas fa-check"></i></a>
                                                <?php } else {?>
