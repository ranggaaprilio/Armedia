                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class=" col-lg-10 col-md-8 col-sm-8 col-xs-8">
                                <a href="<?php echo base_url() . 'pendaftaran/add_pasien'; ?>" class="btn btn-rounded btn-xs text-white" style="background-color: #00897b !important">Tambah Pasien</a>
                            </div>
                        </div>
                                    ...
                                    foreach ($pasien as $j) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="nowrap">
                                                ...
                                                <a href="<?php echo base_url() . 'pendaftaran/form_daftar/' . $j->no_rekamedis ?>" class="btn btn-success btn-xs"><i class="far fa-clipboard"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                } ?>
