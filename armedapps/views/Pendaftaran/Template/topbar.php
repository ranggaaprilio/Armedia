                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info" style="background-color: #00897b !important">
                                 ...
                                 <a class="dropdown-item" href="<?php echo base_url('Pendaftaran/account/').$this->session->userdata('id'); ?>"><i class="fas fa-user mr-2"></i>Account</a>
    ...
    <div class="modal-content">
        ...
        <h5 class="modal-title">Ganti Password</h5>
         ...
         <div class="modal-body">
            <form action="pendaftaran/g_pass" method="post">
             <div class="col-md-9">
