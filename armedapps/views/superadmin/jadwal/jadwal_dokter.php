                                ...
                                <tbody>
                                    ...
                                    foreach ($jadwal as $j) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="nowrap">
                                                <a href="<?php echo base_url() . 'superadmin/edit_jadwal/' . $j->id_dokter ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                                <a href="<?php echo base_url() . 'superadmin/delete_jadwal/' . $j->id_dokter ?>" class="btn btn-warning btn-xs"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                } ?>
