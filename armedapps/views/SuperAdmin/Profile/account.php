                  ...
                  <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-04 ">
                            <img src="<?php echo base_url('assets/img/user/').$o->foto ?>" alt="Tidak ada gambar" class="rounded-circle " height=400px width=400px>  
                        </div>
                        <div class="col-md-4 col-sm-04 "></div>                
                    </div>
                   <div class="row">
                ...
                <form>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" readonly class="form-control-plaintext  " id="staticEmail" value="Owner" style="font-size: 2rem">
                    </div>
                  </div>
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <?php
                        foreach ($owner as $e) {
                            ?>
                         <form action="<?= base_url('superadmin/update_profile') ?>" method="post" enctype="multipart/form-data">
                            <input type="hidden" value="<?php echo $e->id_owner ?>" name="id">
                            <!-- Nama Lengkap -->
