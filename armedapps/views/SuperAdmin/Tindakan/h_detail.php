        ...
        <div class="container-fluid dashboard-content ">
            ...
            <div class="modal fade  bd-example-modal-lg" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalCenterTitle">Input Riwayat Rekamedis <?=$n_pasien?></h3><br>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            foreach ($daftar as $e) {
                                ?>
                                <?php echo form_open('superadmin/input_rekam_hamil'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="nowrap">
                                                <?php foreach ($daftar as $k) {?>
                                                   <a href="<?php echo base_url().'superadmin/masukan_obat/' . $o->id_obat.'/'.$k->no_rekamedis.'/'.$k->kategori.'/'.$k->no_rawat ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                                <?php } ?>
