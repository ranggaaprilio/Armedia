            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url() . 'SuperAdmin/Daftar_admin' ?>" style="color: #00897b;
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url() . 'SuperAdmin/Data_dokter' ?>" style="color: #00897b;
                            text-decoration: none;">
                            <div class="panel-footer">
                                <span class="pull-left">Lihat Detail</span>
                                <span class="pull-right"><i class="fas fa-arrow-alt-circle-right"></i></span>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url() . 'SuperAdmin/Data_obat' ?>" style="color: #00897b;
                            text-decoration: none;">
                            <div class="panel-footer">
                                <span class="pull-left">Lihat Detail</span>
                                <span class="pull-right"><i class="fas fa-arrow-alt-circle-right"></i></span>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url() . 'SuperAdmin/Data_pasien' ?>" style="color: #00897b;
                            text-decoration: none;">
                            <div class="panel-footer">
                                <span class="pull-left">Lihat Detail</span>
                                <span class="pull-right"><i class="fas fa-arrow-alt-circle-right"></i></span>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="<?php echo base_url() . 'SuperAdmin/Data_pendaftaran' ?>" style="color: #00897b;
                            text-decoration: none;">
                            <div class="panel-footer">
