            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo base_url() . 'superadmin/add_obat'; ?>" class="btn btn-rounded btn-xs text-white" style="background-color: #00897b !important">Tambah Obat</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($obat as $o) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="nowrap">
                                                <a href="<?php echo base_url() . 'superadmin/edit_obat/' . $o->id_obat ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                                <a href="<?php echo base_url() . 'superadmin/delete_obat/' . $o->id_obat ?>" class="btn btn-warning btn-xs"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                } ?>
